...
InsStatus$Round_off <- round(InsStatus$percentage) # Round off the column to integer
...
By Race {data-navmenu="Insurance Status"}
=====================================
...
```{r insurance status}
##value box with number (or percentage) of uninsured children
```

By Poverty Level {data-navmenu="Insurance Status"}
=====================================
