...
ggplot(dataforACEplot) +
 aes(x = FlourishStatus6to17, fill = ACECount) +
 geom_bar(position = "fill") +
 scale_fill_hue(direction = 1) +
 labs(x = "Flourishing Items Met", y = "Children", title = "Flourishing Status & Adverse Childhood Experiences (ACE)", 
 subtitle = "Count of Children Meeting Flourishing Criteria by Number of Adverse Childhood Experiences", 
...
dataforACEplot %>%
 ...
 direction = 1) +
 labs(x = "Race", y = "Proportion of Children", title = "Adverse Childhood Experiences (ACE) by Race", 
 caption = "Based on National Survey of Children's Health, 2019-2020", fill = "Number of ACEs") +
 theme_minimal()
